...
public class UserData{
	...
	private int startupFollow;

	@SerializedName("is_pro")
	private int isPro;

	@SerializedName("startup_info")
	private int startupInfo;
	...
	public void setStartupAvatar(int startupAvatar){
		this.startupAvatar = startupAvatar;
	}

	public int getStartupAvatar(){
	...
	public void setStartupFollow(int startupFollow){
		this.startupFollow = startupFollow;
	}

	public int getStartupFollow(){
	...
	public void setStartupInfo(int startupInfo){
	...
	@Override
 	public String toString(){
		return 
			...
			",posts = '" + posts + '\'' + 
			",cover = '" + cover + '\'' + 
			",n_on_comment_like = '" + nOnCommentLike + '\'' + 
			",mode = '" + mode + '\'' + 
			",twitter = '" + twitter + '\'' + 
			",balance = '" + balance + '\'' + 
			",fname = '" + fname + '\'' + 
			...
			",following = '" + following + '\'' + 
			",b_site_action = '" + bSiteAction + '\'' + 
			",name = '" + name + '\'' + 
			",is_following = '" + isFollowing + '\'' + 
			",country_id = '" + countryId + '\'' + 
			",n_on_follow = '" + nOnFollow + '\'' + 
			",gender = '" + gender + '\'' + 
			",admin = '" + admin + '\'' + 
			",n_on_like = '" + nOnLike + '\'' + 
			",b_phone = '" + bPhone + '\'' + 
			",n_on_comment_reply = '" + nOnCommentReply + '\'' + 
			",lname = '" + lname + '\'' + 
			",n_on_comment = '" + nOnComment + '\'' + 
			",n_on_mention = '" + nOnMention + '\'' + 
			",email = '" + email + '\'' + 
			",b_name = '" + bName + '\'' + 
			",website = '" + website + '\'' + 
			",wallet = '" + wallet + '\'' + 
